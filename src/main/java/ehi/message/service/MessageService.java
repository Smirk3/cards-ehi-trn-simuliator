...
import ehi.web.service.client.soap.schemas.gps.ResponseMsg;
...
public class MessageService {
    ...
    public String createNewRequest(Message message) {
        ...
        //GetTransactionResponse response = (GetTransactionResponse) soapConnector.callWebService(message.ehiUrl, createXmlRequest(message));
        //return generateXml(response);

    }

    private static String toXml(Object object, Class klass) {
        try {
